/*
 * This file is part of the GeoLatte project. GeoLatte is free software: you can
 * redistribute it and/or modify it under the terms of the GNU Lesser General
 * Public License as published by the Free Software Foundation, either version 3
 * of the License, or (at your option) any later version. GeoLatte is
 * distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY;
 * without even the implied warranty of MERCHANTABILITY or FITNESS FOR A
 * PARTICULAR PURPOSE. See the GNU Lesser General Public License for more
 * details. You should have received a copy of the GNU Lesser General Public
 * License along with GeoLatte. If not, see <http://www.gnu.org/licenses/>.
 * Copyright (C) 2010 - 2014 and Ownership of code is shared by: Qmino bvba -
 * Romeinsestraat 18 - 3001 Heverlee (http://www.qmino.com) Geovise bvba -
 * Generaal Eisenhowerlei 9 - 2140 Antwerpen (http://www.geovise.com)
 */
 ...
 *
 * @author Karel Maesen, Geovise BVBA creation-date: 4/3/14
 */
public class Positions {
	...
	static {
		registeredFactories =
				Arrays.asList(new CanMakeG2D(), new CanMakeG2DM(), new CanMakeG3D(), new CanMakeG3DM(),
						new CanMakeP2D(), new CanMakeP2DM(), new CanMakeP3D(), new CanMakeP3DM());
	}

	/**
	 * Factory method for {@code Position}s in the reference system.
	 * <p/>
	 * The coordinates array should be in normalized order. See {@link Position}
	 *
	 * @param coordinates
	 ...
	 * <p/>
	 * <P>
	 * The coordinates are taken as-is. If the target coordinate reference
	 * systems has a larger coordinate dimensions then the source, NaN
	 * coordinate values are created.
	 * </p>
	 *
	 * @param source
	 * @param targetPosClass
	 *            target type of {@code Position}
	 * @param <P>
	...
	public static class CanMakeP3D implements PositionFactory<C3D> {
		...
		public C3D mkPosition(double... coordinates) {
			/*
			 * GEOGRAT-CM: In some cases we do not have 3 coordinates here but
			 * only two. in this case we are using 0.0 as z coordinate.
			 */
			return coordinates.length == 0 ? new C3D() : new C3D(coordinates[0], coordinates[1],
