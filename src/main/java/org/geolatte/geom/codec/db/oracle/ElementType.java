 ...
 */
enum ElementType {
	UNSUPPORTED(0, true), POINT(1, 1), ORIENTATION(1, 0), POINT_CLUSTER(1, true), LINE_STRAITH_SEGMENTS(2, 1),
	LINE_ARC_SEGMENTS(2, 2), INTERIOR_RING_STRAIGHT_SEGMENTS(2003, 1),
	/** Some sort of old geometry. */
	PLAIN_OLD_EXTERIOR_RING_STRAIGHT_SEGMENTS(3, 1), PLAIN_OLD_COMPOUND_EXTERIOR_RING(5, true),
	/** Straight segments. */
	EXTERIOR_RING_STRAIGHT_SEGMENTS(1003, 1), INTERIOR_RING_ARC_SEGMENTS(2003, 2), EXTERIOR_RING_ARC_SEGMENTS(1003, 2),
	INTERIOR_RING_RECT(2003, 3), EXTERIOR_RING_RECT(1003, 3), INTERIOR_RING_CIRCLE(2003, 4), EXTERIOR_RING_CIRCLE(1003,
			4), COMPOUND_LINE(4, true), COMPOUND_EXTERIOR_RING(1005, true),
	...
	/**
	 * @return true, if the SDO_INTERPRETATION value is the number of points or
	 *         compounds in the element.
	 */
