 ...
 *
 */
public class LengthUnit extends CrsIdentifiable implements Unit {



    //common units
    public final static LengthUnit DEGREE = new LengthUnit(new CrsId("EPSG",9122), "degree", Type.ANGULAR, 0.01745329251994328);
    public final static LengthUnit RADIAN = new LengthUnit(new CrsId("EPSG", 9101), "radian", Type.ANGULAR, 1);
    public final static LengthUnit METER = new LengthUnit(new CrsId("EPSG", 9001), "metre", Type.LINEAR, 1);

    //this is used when the units can't be determined.
    public final static LengthUnit UNKNOWN = new LengthUnit(CrsId.UNDEFINED, "unknown", Type.LINEAR, 1);
     ...
     */
    public LengthUnit(CrsId crsId, String name, Type type, double conversionFactor) {
        super(crsId, name);
        this.type = type;
    ...
    public boolean equals(Object o) {
        ...
        if (Double.compare(lengthUnit.conversionFactor, conversionFactor) != 0) return false;
        if (type != lengthUnit.type) return false;
