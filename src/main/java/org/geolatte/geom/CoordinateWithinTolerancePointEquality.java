...
/**
 * A {@link PointEquality} that considers <code>Point</code>s to be equal when their coordinates
 * are within a specified tolerance of each other.
 *
 * @author Karel Maesen, Geovise BVBA
 *         creation-date: 4/25/12
 */
public class CoordinateWithinTolerancePointEquality extends AbstractPointEquality {
