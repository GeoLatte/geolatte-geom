 ...
 */
public class TestHANAWktTokenizer {

	private static CoordinateReferenceSystem<C2D> crs = CoordinateReferenceSystems.PROJECTED_2D_METER;

	private WktVariant words = new HANAWktVariant();

	@Test
	public void test_only_whitespace() {
		String wkt = "    ";
		HANAWktTokenizer tokenizer = new HANAWktTokenizer( wkt, words, crs );
	...
	public void test_tokenize_empty_point() {
		...
		HANAWktTokenizer tokens = new HANAWktTokenizer( wkt, words, crs );
		assertTrue( tokens.moreTokens() );
		HANAWktGeometryToken token = (HANAWktGeometryToken) ( tokens.nextToken() );
		assertEquals( GeometryType.POINT, token.getType() );
		assertFalse( token.isMeasured() );
		assertFalse( token.is3D() );
		assertTrue( tokens.moreTokens() );
	...
	public void test_tokenize_point_3D() {
		String wkt = "POINT Z(20 33.3 .24)";
		HANAWktTokenizer tokens = new HANAWktTokenizer( wkt, words, crs );
		assertTrue( tokens.moreTokens() );
		HANAWktGeometryToken token = (HANAWktGeometryToken) ( tokens.nextToken() );
		assertEquals( GeometryType.POINT, token.getType() );
		assertFalse( token.isMeasured() );
		assertTrue( token.is3D() );
		assertTrue( tokens.moreTokens() );
		assertEquals( tokens.nextToken(), words.getOpenList() );
		assertTrue( tokens.moreTokens() );
		WktPointSequenceToken pstoken = (WktPointSequenceToken) ( tokens.nextToken() );
	...
	@Test
	public void test_tokenize_point_M_3D() {
		String wkt = "POINT ZM (20 33.3 44.4 .24)";
		HANAWktTokenizer tokens = new HANAWktTokenizer( wkt, words, crs );
		assertTrue( tokens.moreTokens() );
		HANAWktGeometryToken token = (HANAWktGeometryToken) ( tokens.nextToken() );
		assertEquals( GeometryType.POINT, token.getType() );
		...
		WktPointSequenceToken pstoken = (WktPointSequenceToken) ( tokens.nextToken() );
		assertEquals( 1, pstoken.getPositions().size() );
		C3DM pos = (C3DM) pstoken.getPositions().getPositionN( 0 );
		assertEquals( 20, pos.getX(), Math.ulp( 20d ) );
		assertEquals( 33.3, pos.getY(), Math.ulp( 20d ) );
		assertEquals( 44.4, pos.getZ(), Math.ulp( 20d ) );
		assertEquals( 0.24, pos.getM(), Math.ulp( 2d ) );
		assertTrue( tokens.moreTokens() );
		assertEquals( tokens.nextToken(), words.getCloseList() );
		assertFalse( tokens.moreTokens() );
	...
	public void test_tokenize_invalid_point() {
		String wkt = "POINT MZ(20 33.3)";
		HANAWktTokenizer tokens = new HANAWktTokenizer( wkt, words, crs );
		assertTrue( tokens.moreTokens() );
		HANAWktGeometryToken token = (HANAWktGeometryToken) ( tokens.nextToken() );
		assertEquals( GeometryType.POINT, token.getType() );
	...
	public void test_tokenize_linestring() {
		String wkt = "LINESTRING Z(20 33.3 .24 , .1 2 3)";
		HANAWktTokenizer tokens = new HANAWktTokenizer( wkt, words, crs );
		assertTrue( tokens.moreTokens() );
		HANAWktGeometryToken token = (HANAWktGeometryToken) ( tokens.nextToken() );
	...
	@Test
	public void testHANAWktTokenizerToDoubleSampleValues() {
		HANAWktTokenizer tokens = null;
		String[] strings = {
				"12.345 ",
				"123456.1234 ",
				"123456789.12345 ",
		...
		for ( String s : strings ) {
			tokens = new HANAWktTokenizer( s, words, crs );
	...
	@Test
	public void testHANAWktTokenizerToDoubleRandomValues() {
		HANAWktTokenizer tokens = null;
	...
	@Test
	public void testHANAWktTokenizerToDoubleOnValueLargerThanMaxValue() {
		HANAWktTokenizer tokens = null;
	...
	@Test
	public void testHANAWktTokenizerToDoubleOnValueLargerThanMinValue() {
		HANAWktTokenizer tokens = null;
		String wkt = "4.8E-326 ";
		tokens = new HANAWktTokenizer( wkt, words, crs );
	...
	@Test
	public void testHANAWktTokenizerOnVeryLongDigitalExpansion() {
		HANAWktTokenizer tokens = null;
